...
- Node palette entries use single-click to select, double-click to add at the default layout slot, and drag-drop to add at the drop position. Palette additions do not auto-connect to the previous node or inject hidden previous-node bindings.
