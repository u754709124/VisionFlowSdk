    ...
    internal static class Program
    {
        ...
        private static async Task<int> RunAsync()
        {
            var tests = new List<TestCase>
            {
                ...
                new TestCase("Designer ports and edges use circular anchors and visible arrows", DesignerInteractionTests.PortsAndEdgesUseCircularAnchorsAndVisibleArrows),
