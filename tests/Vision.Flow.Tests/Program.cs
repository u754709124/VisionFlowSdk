    ...
    internal static class Program
    {
        ...
        private static async Task<int> RunAsync()
        {
            var tests = new List<TestCase>
            {
                ...
                new TestCase("Schema v2 design files are rejected", SerializationTests.DesignV2IsRejected),
                new TestCase("Schema v2 runtime files are rejected", SerializationTests.RuntimeV2IsRejected),
                new TestCase("Removed StopFlow strategy is rejected", SerializationTests.StopFlowStrategyIsRejected),
                ...
                new TestCase("FlowValidator requires compatible typed condition operands", FlowValidationPublishTests.ConditionRequiresCompatibleTypedOperands),
                ...
                new TestCase("FlowValidator requires every chain start to have a matching entry", FlowValidationPublishTests.ChainStartsRequireMatchingEntries),
                ...
                new TestCase("Dynamic descriptor settings keep schema v3 serialization", DynamicDescriptorTests.DynamicDescriptorSettingsKeepSchemaV3Serialization),
                ...
                new TestCase("Node failure defaults to StopBranch", NodeExecutionPolicyTests.StopBranchIsTheDefaultFailureStrategy),
                ...
                new TestCase("Node ErrorBranch without a connection fails its branch", NodeExecutionPolicyTests.ErrorBranchWithoutConnectionFailsCurrentBranch),
                ...
                new TestCase("Parallel StopBranch preserves sibling branches", ReadyQueueSchedulingTests.ParallelStopBranchPreservesSiblingBranch),
                new TestCase("Parallel missing ErrorBranch preserves sibling branches", ReadyQueueSchedulingTests.ParallelMissingErrorBranchPreservesSiblingBranch),
